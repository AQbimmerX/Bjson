...
class WellcomeHeadlightTab(tb.Frame):
    ...
    def create_widgets(self):
        ...
        tb.Label(self, text="BMW Welcome Light Editor PreLCI G20..", font=("Segoe UI", 18, "bold"), bootstyle="primary").pack(pady=10)
    ...
    def generate_custom_sequence(self):
        ...
        # Ensure both sequences have at least one entry
        ...
        # Auto scroll to top if inside a ScrolledFrame
        parent = self.master
        try:
